...
function AlbumItem() {
    return (
        <div className='flex flex-col col-span-1 text-sm cursor-pointer'>
            <div className="relative rounded-lg pb-4 overflow-hidden">
                ...
                <p className='absolute text-xs font-semibold bg-teal-500 text-white bottom-5 left-2 p-1 rounded'>Album</p>
            </div>
